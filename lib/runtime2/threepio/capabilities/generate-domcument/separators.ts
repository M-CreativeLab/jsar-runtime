...
// Stream separators (optional, for streaming responses)
export const S_HTML_START = 'SH#';    // html stream start
export const S_NODE_START = 'N:';     // node stream start
export const S_CSS_START = 'CS:';   // css stream start
export const S_HTML_END = 'EH#';    // html stream end
