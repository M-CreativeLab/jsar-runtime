...
/**
 * The json chunk is the chunk in the stream and contains the json generated by the JSONLProcessor.
 */
...
/**
 * The error chunk indicates an error occurred during stream processing.
 */
export interface ApiStreamErrorChunk {
  ...
  error: {
    ...
    [key: string]: any; // Allow other error properties
  };
}
