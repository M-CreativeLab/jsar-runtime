...
type IDisposable = BABYLON.IDisposable;
type Scene = BABYLON.Scene;
type AbstractMesh = BABYLON.AbstractMesh;
type Nullable<T> = BABYLON.Nullable<T>;

const { Observable, Logger, SceneLoader, Quaternion, Vector3, Mesh } = BABYLON;
...
export abstract class WebXRAbstractMotionController implements IDisposable {
   ...
   */
  public onModelLoadedObservable: BABYLON.Observable<WebXRAbstractMotionController> = new Observable();
  /**
