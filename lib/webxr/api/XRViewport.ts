...
export default class XRViewportImpl implements XRViewport {
   ...
   * @return {number}
   */
  get x(): number { return this[PRIVATE].target.x; }

  /**
   * @return {number}
   */
  get y(): number { return this[PRIVATE].target.y; }

  /**
   * @return {number}
   */
  get width(): number { return this[PRIVATE].target.width; }

  /**
   * @return {number}
   */
  get height(): number { return this[PRIVATE].target.height; }
}
