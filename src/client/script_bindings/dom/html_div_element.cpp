...
namespace script_bindings
{
  namespace dom
  {
    ...
    Local<Object> HTMLDivElement::NewInstance(Isolate *isolate, std::shared_ptr<::dom::HTMLDivElement> nativeElement)
    {
      ...
      return scope.Escape(scripting_base::ObjectWrap<HTMLDivElement, ::dom::HTMLDivElement, HTMLElement>::NewInstance(isolate, nativeElement).As<Object>());
    }

    // static
    Local<Function> HTMLDivElement::Initialize(Isolate *isolate)
    {
      return scripting_base::ObjectWrap<HTMLDivElement, ::dom::HTMLDivElement, HTMLElement>::Initialize(isolate);
    }

    HTMLDivElement::HTMLDivElement(Isolate *isolate, const FunctionCallbackInfo<Value> &args)
        : scripting_base::ObjectWrap<HTMLDivElement, ::dom::HTMLDivElement, HTMLElement>(isolate, args)
    {
    }
  }
}