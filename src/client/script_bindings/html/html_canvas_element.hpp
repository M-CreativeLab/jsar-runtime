...
namespace script_bindings
{
  namespace html
  {
    ...
    public:
      ...
      /**
       * Configure the V8 function template with HTMLCanvasElement properties and methods.
       */
      static void ConfigureFunctionTemplate(v8::Isolate *isolate, v8::Local<v8::FunctionTemplate> tpl);

      /**
       * Create a new V8 HTMLCanvasElement instance from a native dom::HTMLCanvasElement.
       */
      static v8::Local<v8::Object> NewInstance(v8::Isolate *isolate, std::shared_ptr<dom::HTMLCanvasElement> nativeElement);

      /**
       * Initialize the HTMLCanvasElement class and register it with V8.
       */
