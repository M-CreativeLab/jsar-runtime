...
namespace dom
{
  ...
  public:
    ...
    std::string type() const { return getAttribute("type").value_or("text"); }
    void setType(const std::string& value) { setAttribute("type", value); }
    ...
    std::string placeholder() const { return getAttribute("placeholder").value_or(""); }
    void setPlaceholder(const std::string& value) { setAttribute("placeholder", value); }
    
    std::string name() const { return getAttribute("name").value_or(""); }
    void setName(const std::string& value) { setAttribute("name", value); }
