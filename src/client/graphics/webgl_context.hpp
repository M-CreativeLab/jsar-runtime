...
namespace endor
{
   ...
   */
     ...
     */
      ...
      /**
     * It validates a program. It checks if a program can execute given the current WebGL state. The information 
     * generated by the validation process will be stored in the program's information log. The validation 
     * information may consist of an empty string, or it may be a string containing information about how the 
     * current program might execute given the current WebGL state. This information could be useful during 
     * program development.
     *
     * @param program The WebGLProgram object to validate.
     */
