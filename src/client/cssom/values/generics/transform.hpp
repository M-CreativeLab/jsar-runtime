...
namespace client_cssom::values::generics
{
  ...
  {
  public:
    GenericMatrix3D(Number m11, Number m12, Number m13, Number m14, Number m21, Number m22, Number m23, Number m24, Number m31, Number m32, Number m33, Number m34, Number m41, Number m42, Number m43, Number m44)
        : m11_(m11)
        , m12_(m12)
        , m13_(m13)
        , m14_(m14)
  ...
  public:
    const Number &m11() const
    {
      return m11_;
    }
    const Number &m12() const
    {
      return m12_;
    }
    const Number &m13() const
    {
      return m13_;
    }
    const Number &m14() const
    {
      return m14_;
    }
    const Number &m21() const
    {
      return m21_;
    }
    const Number &m22() const
    {
      return m22_;
    }
    const Number &m23() const
    {
      return m23_;
    }
    const Number &m24() const
    {
      return m24_;
    }
    const Number &m31() const
    {
      return m31_;
    }
    const Number &m32() const
    {
      return m32_;
    }
    const Number &m33() const
    {
      return m33_;
    }
    const Number &m34() const
    {
      return m34_;
    }
    const Number &m41() const
    {
      return m41_;
    }
    const Number &m42() const
    {
      return m42_;
    }
    const Number &m43() const
    {
      return m43_;
    }
    const Number &m44() const
    {
      return m44_;
    }
  ...
  public:
    const LengthPercentage &x() const
    {
      return x_;
    }
    const LengthPercentage &y() const
    {
      return y_;
    }
  ...
  public:
    ...
    static T Matrix3D(Number m11, Number m12, Number m13, Number m14, Number m21, Number m22, Number m23, Number m24, Number m31, Number m32, Number m33, Number m34, Number m41, Number m42, Number m43, Number m44)
    {
      return T(kMatrix3D, GenericMatrix3D<Number>(m11, m12, m13, m14, m21, m22, m23, m24, m31, m32, m33, m34, m41, m42, m43, m44));
    }
    static T Skew(Angle x, Angle y)
    {
      return T(kSkew, GenericSkew<Angle>(x, y));
    }
    static T SkewX(Angle angle)
    {
      return T(kSkewX, GenericSkewX<Angle>(angle));
    }
    static T SkewY(Angle angle)
    {
      return T(kSkewY, GenericSkewY<Angle>(angle));
    }
  ...
  public:
    ...
    inline const bool isMatrix() const
    {
      return tag_ == kMatrix;
    }
    inline const bool isMatrix3D() const
    {
      return tag_ == kMatrix3D;
    }
    inline const bool isSkew() const
    {
      return tag_ == kSkew;
    }
    inline const bool isSkewX() const
    {
      return tag_ == kSkewX;
    }
    inline const bool isSkewY() const
    {
      return tag_ == kSkewY;
    }
    inline const bool isTranslate() const
    {
      return tag_ == kTranslate;
    }
    inline const bool isTranslateX() const
    {
      return tag_ == kTranslateX;
    }
    inline const bool isTranslateY() const
    {
      return tag_ == kTranslateY;
    }
    inline const bool isTranslateZ() const
    {
      return tag_ == kTranslateZ;
    }
    inline const bool isTranslate3D() const
    {
      return tag_ == kTranslate3D;
    }
    inline const bool isScale() const
    {
      return tag_ == kScale;
    }
    inline const bool isScaleX() const
    {
      return tag_ == kScaleX;
    }
    inline const bool isScaleY() const
    {
      return tag_ == kScaleY;
    }
    inline const bool isScaleZ() const
    {
      return tag_ == kScaleZ;
    }
    inline const bool isScale3D() const
    {
      return tag_ == kScale3D;
    }
    inline const bool isRotate() const
    {
      return tag_ == kRotate;
    }
    inline const bool isRotateX() const
    {
      return tag_ == kRotateX;
    }
    inline const bool isRotateY() const
    {
      return tag_ == kRotateY;
    }
    inline const bool isRotateZ() const
    {
      return tag_ == kRotateZ;
    }
    inline const bool isRotate3D() const
    {
      return tag_ == kRotate3D;
    }

    const GenericMatrix<Number> &getMatrix() const
    {
      return std::get<GenericMatrix<Number>>(operation_);
    }
    const GenericMatrix3D<Number> &getMatrix3D() const
    {
      return std::get<GenericMatrix3D<Number>>(operation_);
    }
    const GenericSkew<Angle> &getSkew() const
    {
      return std::get<GenericSkew<Angle>>(operation_);
    }
    const GenericSkewX<Angle> &getSkewX() const
    {
      return std::get<GenericSkewX<Angle>>(operation_);
    }
    const GenericSkewY<Angle> &getSkewY() const
    {
      return std::get<GenericSkewY<Angle>>(operation_);
    }
    ...
    const GenericScale<Number> &getScale() const
    {
      return std::get<GenericScale<Number>>(operation_);
    }
    const GenericScaleX<Number> &getScaleX() const
    {
      return std::get<GenericScaleX<Number>>(operation_);
    }
    const GenericScaleY<Number> &getScaleY() const
    {
      return std::get<GenericScaleY<Number>>(operation_);
    }
    const GenericScaleZ<Number> &getScaleZ() const
    {
      return std::get<GenericScaleZ<Number>>(operation_);
    }
    const GenericScale3D<Number> &getScale3D() const
    {
      return std::get<GenericScale3D<Number>>(operation_);
    }
    const GenericRotate<Angle> &getRotate() const
    {
      return std::get<GenericRotate<Angle>>(operation_);
    }
    const GenericRotateX<Angle> &getRotateX() const
    {
      return std::get<GenericRotateX<Angle>>(operation_);
    }
    const GenericRotateY<Angle> &getRotateY() const
    {
      return std::get<GenericRotateY<Angle>>(operation_);
    }
    const GenericRotateZ<Angle> &getRotateZ() const
    {
      return std::get<GenericRotateZ<Angle>>(operation_);
    }
  ...
  public:
    ...
    inline std::vector<T> &operations()
    {
      return operations_;
    }
    inline const std::vector<T> &operations() const
    {
      return operations_;
    }
