...
namespace endor
{
  namespace client_inspector::domains
  {
    ...
    CdpLogDomain::CdpLogDomain()
    {
    }

    string CdpLogDomain::handleMethod(const string &method, const CdpMessage &message)
    {
      if (method == "enable")
      {
    ...
    string CdpLogDomain::enable(const CdpMessage &message)
    {
      enabled_ = true;
    ...
    string CdpLogDomain::disable(const CdpMessage &message)
    {
      enabled_ = false;
    ...
    string CdpLogDomain::clear(const CdpMessage &message)
    {
      logBuffer_.clear();
    ...
    string CdpLogDomain::startViolationsReport(const CdpMessage &message)
    {
    ...
    string CdpLogDomain::stopViolationsReport(const CdpMessage &message)
    {
      violationsReportEnabled_ = false;
      violationTypes_.clear();
    ...
    void CdpLogDomain::addLogEntry(const LogEntry &entry)
    {
      // Store in buffer
    ...
    string CdpLogDomain::createLogEntryEvent(const LogEntry &entry)
    {
    ...
    rapidjson::Value CdpLogDomain::logEntryToJson(const LogEntry &entry, rapidjson::Document::AllocatorType &allocator)
    {
