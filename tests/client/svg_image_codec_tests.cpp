...
<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="10" width="80" height="80" fill="red"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "test.svg", 200, 300);
...
<svg width="100" height="50" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="10" width="80" height="30" fill="blue"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "test.svg", 200, -1);
...
<svg width="100" height="50" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="10" width="80" height="30" fill="green"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "test.svg", -1, 100);
...
<svg width="50" height="50" xmlns="http://www.w3.org/2000/svg">
  <circle cx="25" cy="25" r="20" fill="blue"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "test_circle.svg");
...
<svg width="8192" height="8192" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="8192" height="8192" fill="green"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "large.svg");
...
<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
  <rect x="0" y="0" width="100" height="100" fill="purple"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "large_target.svg", 2048, 2048);
  ...
  SECTION("Invalid SVG data")
  {
    ...
    bool success = ImageCodec::Decode(invalid_data, nullptr, decoded_bitmap, "invalid.svg");
  ...
  SECTION("Empty SVG data")
  {
    ...
    bool success = ImageCodec::Decode(empty_data, nullptr, decoded_bitmap, "empty.svg");
...
<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="10" width="80" height="80" fill="red"
    ...
    bool success = ImageCodec::Decode(malformed_data, nullptr, decoded_bitmap, "malformed.svg");
...
TEST_CASE("SVG Image Codec compatibility with existing formats", "[svg-codec]")
{
  SECTION("Non-SVG data should still work")
  {
    ...
    std::vector<char> png_signature = {
      static_cast<char>(0x89), 'P', 'N', 'G', static_cast<char>(0x0D), static_cast<char>(0x0A), static_cast<char>(0x1A), static_cast<char>(0x0A)};

    SkBitmap decoded_bitmap;
    bool success = ImageCodec::Decode(png_signature, nullptr, decoded_bitmap, "test.png");
...
<body>
  <svg width="100" height="100">
    ...
    bool success = ImageCodec::Decode(html_data, nullptr, decoded_bitmap, "test.html");
...
<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
  <rect x="50" y="50" width="100" height="100" fill="purple"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "viewbox.svg");
...
<SVG WIDTH="100" HEIGHT="100" xmlns="http://www.w3.org/2000/svg">
  <rect x="10" y="10" width="80" height="80" fill="orange"/>
    ...
    bool success = ImageCodec::Decode(svg_data, nullptr, decoded_bitmap, "uppercase.svg");
    REQUIRE(success == true);
  }
}
