...
<img alt="screenshot" src="../../playwebxr-screenshot-input.png" height="350">

Then you can see your application is opened there:

<img alt="screenshot" src="../../playwebxr-screenshot-opened.png" height="350">
...
<img alt="screenshot" src="../../playwebxr-screenshot-apps.png" height="350">
...
```sh
$ ./jsar_desktop_opengl -xr -w800 /Users/yorkie/workspace/jsar-runtime/fixtures/html/canvas.html
```

<img alt="screenshot" src="../../macos-simulator-screenshot.png" height="400">
